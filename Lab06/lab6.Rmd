...
x <- as.numeric(data[which(data[,2]==1),1])
z <- as.numeric(data[which(data[,2]==2),1])
...
while(current_id < max_id){
  q <- (1/(1-exp(-lambda * z)))*((1/lambda) -(z + (1/lambda))* xp(-lambda * z))
...
hist(as.numeric(data[,1]), freq=F, main="Histogram of all data")
lines(density(as.numeric(data[,1]), adjust = 1/lambda), lwd = 2)

hist(as.numeric(data[which(data[,2]==1),1]), freq=F, main="Histogram of cens=1 data")
lines(density(as.numeric(data[which(data[,2]==1),1]), adjust = 1/lambda), lwd = 2)
