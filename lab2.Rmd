...
See appendix 2-a for the code of the function steepestasc.
...
```
The result is slightly different after 4 digits, but esentialy the same point. Ou function is more precise, because we can choose the epsilon value for the stopping criterion.
For reference, our function used Function calls: 26 and Gradiant calls: 43 
Nelder-Mead used  Function calls: 48 and Gradiant calls: 0
BFGS used Function calls: 12 and Gradiant calls: 0
...
We get the same result as the glm function
